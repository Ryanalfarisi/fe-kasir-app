...
const getStockStatus = (stock) => {
  if (stock <= 5)
    return { text: "Low Stock", class: "bg-red-100 text-red-800" };
  if (stock <= 20)
...
<template>
  <DashboardLayout>
    ...
    <!-- Filters -->
    <div
      class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6 flex flex-col sm:flex-row gap-4"
    >
        ...
        <table class="w-full text-left">
          <thead class="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th class="p-4 font-semibold text-gray-600 text-center">
                Status
              </th>
